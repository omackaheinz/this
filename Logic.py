...
############    main game logic
    ...
    def play(self, coords):
        ...
        if self.alreadyPlacedCheck(self.board,coords):
            ...
            if not suicide and  self.koCheck(self.temp_board, self.history[1]):
...
############    checking
    ...
    def koCheck(self, board, boardHistory):
        koTempBoard = deepcopy(board)

        if koTempBoard in boardHistory:
            return False
        return True
